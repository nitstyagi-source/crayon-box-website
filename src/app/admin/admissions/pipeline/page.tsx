    ...
    <div className="flex flex-col h-[calc(100vh-6rem)] space-y-4 font-sans max-w-full">
      ...
      <div className="bg-white p-5 rounded-3xl border border-stone-200/80 shadow-xs flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          >
            <UserPlus className="w-3.5 h-3.5" /> + Record New Lead (In ERP)
          </button>
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 shadow-2xl border border-stone-200 animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleCreateDirectEnquiry} className="space-y-4 pt-4">
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <label htmlFor="transportReqPipe" className="text-xs font-bold text-stone-700">
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-stone-100">
                ...
                <button
                  ...
                  className="px-5 py-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-xs transition flex items-center gap-1.5 cursor-pointer"
                >
