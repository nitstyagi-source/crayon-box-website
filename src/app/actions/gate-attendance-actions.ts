  ...
  try {
    ...
    return {
      ...
      student: {
        ...
        transportMode: stu.transport_mode || 'OWN_TRANSPORT',
        parentName: stu.parent_first ? `${stu.parent_first} ${stu.parent_last || ''}`.trim() : 'Primary Guardian',
        parentPhone: stu.parent_phone || null,
      },
      attendance: {
        date: todayStr,
