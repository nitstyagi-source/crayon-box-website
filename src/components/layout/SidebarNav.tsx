...
export function SidebarNav({ currentRole = 'SUPER_ADMIN', isMobileOpen = false, onCloseMobile }: SidebarNavProps) {
  ...
  const EXECUTIVE_HUBS: ExecutiveHub[] = [
    ...
    },
    {
      ...
      subtitle: 'Intake, CRM & Student 360',
      icon: GraduationCap,
      accentColor: '#38BDF8',
      allowedRoles: ['SUPER_ADMIN', 'PRINCIPAL', 'TEACHER', 'ACCOUNTS', 'PARENT'],
      items: [
        { name: 'Admissions Command Suite', href: '/admin/admissions', icon: Sparkles, badge: 'Suite', roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS'] },
        { name: 'Student & Family 360 Master', href: '/admin/students', icon: Users, badge: 'Master', roles: ['SUPER_ADMIN', 'PRINCIPAL', 'TEACHER', 'ACCOUNTS'] },
        { name: 'Review Pipeline & Kanban', href: '/admin/admissions?tab=pipeline', icon: Layers, roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS'] },
        { name: 'Walk-ins & Enquiries CRM', href: '/admin/admissions?tab=enquiries', icon: PhoneCall, roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS'] },
        { name: 'Family 360 & Siblings', href: '/admin/families', icon: Users, roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS', 'PARENT'] },
        { name: 'CBSE Transfer Cert (TC)', href: '/admin/students/tc', icon: FileText, roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS'] },
        { name: '24/7 AI WhatsApp Bot', href: '/admin/admissions?tab=ai-bot', icon: Sparkles, badge: 'AI', roles: ['SUPER_ADMIN', 'PRINCIPAL', 'ACCOUNTS'] },
      ],
    },
    {
      id: 'academics',
