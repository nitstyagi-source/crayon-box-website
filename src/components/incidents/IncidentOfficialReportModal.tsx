...
export default function IncidentOfficialReportModal({
  ...
  const schoolName = institution?.name || "CRAYON BOX HIGH SCHOOL";
  const schoolAddress = institution?.address || "Main Campus, Knowledge Boulevard, Sector 62, NCR";
  const contactPhone = institution?.phone || "+91 (011) 2891-4400";
  const affiliationNo = "CBSE/AFF/2130891/2026";
  const schoolCode = "CB-70142";
      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full p-4 sm:p-8 shadow-2xl border border-slate-200 text-slate-900 font-sans space-y-5 max-h-[94vh] overflow-y-auto">
        ...
        >
          ...
          <div className="text-center border-t border-slate-200 pt-2 text-[9px] font-mono text-slate-400">
            This document is a certified institutional record generated by Crayon Box School Management System &bull; Timestamp: {new Date().toLocaleString("en-IN")} &bull; Page 1 of 1
          </div>
